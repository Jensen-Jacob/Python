...
def blackjack():
  while True:
    try:
      ...
      if play_choice != "y" and play_choice != "n":
  ...
  while play_game:
    ...
    while not is_game_over:
        ...
        while True:
          try:
            additional_card = input(
                "Do you want to get another card? Type 'y' for yes or 'n' for no: "
            )
            if additional_card != "y" and additional_card != "n":
              raise Exception("Invalid Input! Try again")
            else:
              break
          except Exception as e:
      ...
      if is_game_over:
        print(
            f"Your final hand: {player_cards}, your final score: {player_score}, computer's final hand: {computer_cards}, computer's final score: {computer_score}."
        )
